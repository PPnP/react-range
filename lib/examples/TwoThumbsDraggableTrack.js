...
var TwoThumbsDraggableTrack = function (_a) {
    var rtl = _a.rtl;
    ...
    return (React.createElement("div", { style: {
        ...
        React.createElement(index_1.Range, { draggableTrack: true, values: values, step: STEP, min: MIN, max: MAX, rtl: rtl, onChange: function (values) {
                setValues(values);
        ...
        React.createElement("output", { style: { marginTop: '30px' }, id: "output" },
            values[0].toFixed(1),
            " - ",
            values[1].toFixed(1))));
};
exports.default = TwoThumbsDraggableTrack;
