...
var MIN = 0;
var MAX = 100;
var FinalChangeEvent = function (_a) {
    var rtl = _a.rtl;
    var _b = React.useState([50]), values = _b[0], setValues = _b[1];
    var _c = React.useState([50]), finalValues = _c[0], setFinalValues = _c[1];
    return (React.createElement("div", { style: {
            display: 'flex',
            justifyContent: 'center',
            flexWrap: 'wrap'
        } },
        React.createElement(index_1.Range, { values: values, step: STEP, min: MIN, max: MAX, rtl: rtl, onChange: function (values) { return setValues(values); }, onFinalChange: function (values) { return setFinalValues(values); }, renderTrack: function (_a) {
        ...
        React.createElement("output", { style: { marginTop: '30px' } },
            React.createElement("span", null,
                "onChange value: \u00A0",
                React.createElement("span", { id: "output" }, values[0].toFixed(1))),
            "\u00A0/\u00A0",
            React.createElement("span", null,
                "onFinalChange value: \u00A0",
                React.createElement("span", { id: "final-output" }, finalValues[0].toFixed(1))))));
};
exports.default = FinalChangeEvent;
