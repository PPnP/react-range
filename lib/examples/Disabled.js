...
var Disabled = function (_a) {
    ...
    return (React.createElement("div", { style: {
        ...
        React.createElement(index_1.Range, { disabled: true, values: values, step: STEP, min: MIN, max: MAX, rtl: rtl, onChange: function (values) { return setValues(values); }, renderTrack: function (_a) {
                var props = _a.props, children = _a.children, disabled = _a.disabled;
