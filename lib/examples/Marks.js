...
var Marks = function (_a) {
    ...
    return (React.createElement("div", { style: {
        ...
        React.createElement(index_1.Range, { values: values, step: STEP, min: MIN, max: MAX, rtl: rtl, onChange: function (values) { return setValues(values); }, renderMark: function (_a) {
                var props = _a.props, index = _a.index;
                return (React.createElement("div", __assign({}, props, { style: __assign(__assign({}, props.style), { height: '16px', width: '5px', backgroundColor: index * STEP < values[0] ? '#548BF4' : '#ccc' }) })));
