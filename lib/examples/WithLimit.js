...
var Basic = function (_a) {
    var rtl = _a.rtl;
    var _b = React.useState([20]), values = _b[0], setValues = _b[1];
    return (React.createElement("div", { style: {
            display: 'flex',
            justifyContent: 'center',
            flexWrap: 'wrap'
        } },
        React.createElement(index_1.Range, { values: values, step: STEP, min: MIN, max: MAX, limit: LIMIT, rtl: rtl, onChange: function (values) { return setValues(values); }, renderTrack: function (_a) {
