...
var MultipleThumbsDraggableTrack = function (_a) {
    var rtl = _a.rtl;
    ...
    return (React.createElement("div", { style: {
        ...
        React.createElement(index_1.Range, { draggableTrack: true, values: values, step: STEP, min: MIN, max: MAX, rtl: rtl, onChange: function (values) { return setValues(values); }, renderTrack: function (_a) {
...
exports.default = MultipleThumbsDraggableTrack;
