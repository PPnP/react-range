...
var UpDirection = function (_a) {
    ...
    return (React.createElement("div", { style: {
        ...
        React.createElement(index_1.Range, { direction: index_1.Direction.Up, values: values, step: STEP, min: MIN, max: MAX, onChange: function (values) { return setValues(values); }, renderTrack: function (_a) {
