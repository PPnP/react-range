...
var Range = /** @class */ (function (_super) {
    ...
    function Range(props) {
        ...
        _this.normalizeValue = function (value, index) {
            var _a = _this.props, min = _a.min, max = _a.max, step = _a.step, allowOverlap = _a.allowOverlap, values = _a.values, limit = _a.limit;
            return utils_1.normalizeValue(value, index, min, max, step, allowOverlap, values, limit);
        };
